...
to_game_name['monkey_king']='Monkey King'
to_game_name['abyssal_underlord']='Abyssal Underlord'
to_game_name['arc_warden']='Arc Warden'
...
for url in image_urls:
	...
	file_path = '../statics/heroes_image/%s.png' % hero_name
